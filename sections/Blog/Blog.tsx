...
const Blog = () => {
  return (
      <StyledMain id="blog">
          ...
          <StyledTitleSecondary>See my blog where I discuss my thoughts and teach others while solidifying my own knowledge.</StyledTitleSecondary>
      <StyledBlogs>
        <StyledBlogLink
        ...
        <StyledBlog>
            ...
            <p>How I got to building my own CSS Framework <br /> and why you should too!</p>
          </StyledBlog>
        </StyledBlogLink>
        <StyledBlogLink
