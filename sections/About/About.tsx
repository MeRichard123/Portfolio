  ...
  return (
    <StyledMain id="about">
      ...
      <StyledPara>
        ...
        I am also very interested in NLP and Programming Language Development.
      </StyledPara>
      <StyledPara>
        Unrelated to my studies I enjoy linguistics; languages and the processes in which they aid
        communication have always fascinated me!
      </StyledPara>
      <StyledBtnGroup>
